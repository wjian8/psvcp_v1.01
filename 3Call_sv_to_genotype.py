...
for bam_sample in bam_sample_prefixs:
    ...
    os.system("python3 {4}/structure_variation_calling_script/1depth_call_pav.py {0}/{1}.regions.bed.gz {0}/{1}_{2}depth_{3}bp.txt {2} {3}".format(mosdepth_output_dir,bam_sample,args.depth_threshold,args.min_gap_threshold,script_dir))
