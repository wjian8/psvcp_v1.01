...
echo "Rscript ${script_dir}/construct_pan_script/9gff_split_by_bed3_5.R ${ref_genome_dir}/${ref_fa%.fa}.update1.gff ${ref_genome_dir}/${prefix_base}/${prefix_base}.ins.more_50.bed3 ${ref_genome_dir}/${ref_fa%.fa}.update2.gff"   #output update2.gff
